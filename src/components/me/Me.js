    ...
    <>
      ...
      <div className={styles.container}>
        ...
        <div className={styles.content}>
          ...
          <p className={styles.description}>
            כבר מהשיעור הראשון הבנתי שזה זה! אני דוחפת את עצמי ליותר, אני רוצה להצליח, אני מתרגלת ולומדת ואפילו מגיעה לתוצאות מדהימות! הרגשתי שאני נמצאת סוף סוף במקום שאני צריכה להיות בו. התשוקה הזו הובילה אותי להישגים מדהימים בתחום!. היום, אחרי 3 שנים בתחום, אני גאה להעביר את הידע והניסיון שלי הלאה. 
      ...
      <div className={styles.centeredSection}>
        ...
        <p className={`${styles.description} ${styles.centered}`}>
          תוך 3 שנים של התמדה ונחישות הפכתי מעורכת דין למאסטרית באיפור קבוע
        </p>
